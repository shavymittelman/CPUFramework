...
namespace CPUFramework
{
    public class SQLUtility
    {
        ...
        public static int GetValueFromFirstRowAsInt(DataTable dt, string columname)
        {
            int value = 0;
            if (dt.Rows.Count > 0)
            {
        ...
        public static string GetValueFromFirstRowAsString(DataTable dt, string columname)
        {
            string value = "";
            if (dt.Rows.Count > 0)
            {
